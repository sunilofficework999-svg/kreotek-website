  ...
  return (
    <footer className="bg-gray-900 dark:bg-gray-950 border-t border-gray-800 dark:border-gray-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 leading-relaxed mb-6 max-w-sm">
              Enterprise-grade IT services and SaaS solutions that help
              businesses scale globally. Built with modern technology,
      ...
      <div className="border-t border-gray-800 dark:border-gray-900">
        <div className="container-custom px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
